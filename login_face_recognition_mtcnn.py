...
def registro_facial():
    ...
    contra_entrada.delete(0, END)
    Label(
        pantalla1, text="Registro Facial Exitoso", fg="green", font=("Calibri", 11)
    ).pack()
...
def registro():
    ...
    Label(
        pantalla1, text="Registro tradicional: debe asignar usuario y contraseña:"
    ).pack()
    Label(pantalla1, text="").pack()  # Dejamos un poco de espacio
    ...
    Button(
        pantalla1, text="Registro Facial", width=15, height=1, command=registro_facial
    ).pack()
...
def verificacion_login():
    ...
    if log_usuario in lista_archivos:  # Comparamos los archivos con el que nos interesa
        ...
        if log_contra in verificacion:
            ...
            Label(
                pantalla2, text="Contraseña Incorrecta", fg="red", font=("Calibri", 11)
            ).pack()
    else:
        print("Usuario no encontrado")
        Label(
            pantalla2, text="Usuario no encontrado", fg="red", font=("Calibri", 11)
        ).pack()
...
def login_facial():
    ...
    def orb_sim(img1, img2):
        ...
        if len(matches) == 0:
            return 0
        return len(regiones_similares) / len(
            matches
    ...
    if (
        usuario_login + ".jpg" in im_archivos
    ):  # Comparamos los archivos con el que nos interesa
        rostro_reg = cv2.imread(
            usuario_login + ".jpg", 0
...
def login():
    ...
    Label(
        pantalla2, text="Login tradicional: debe asignar usuario y contraseña:"
    ).pack()
    ...
    Button(
        pantalla2,
        text="Inicio de Sesion Tradicional",
        width=20,
        height=1,
