...
image_filenames = filter(lambda x: x.endswith('.jpg'), os.listdir('photos/'))
# Sort in alphabetical order
image_filenames = sorted(image_filenames)
# Get full paths to images
paths_to_images = ['photos/' + x for x in image_filenames]
...
# Filtering on .jpg extension - so this will only work with JPEG images ending with .jpg
# test_filenames = filter(lambda x: x.endswith('.jpg'), os.listdir('find/'))
test_filenames = os.listdir('find/')
# Get full paths to test images
paths_to_test_images = ['find/' + x for x in test_filenames]
